...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Company Name", "TwerkingPanzerbrigade", "com.example.twerkingpanzerbrigade", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TwerkingPanzerbrigade", null, { width: 800, height: 600 });
